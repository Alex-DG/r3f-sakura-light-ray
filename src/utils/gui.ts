...
class GUIController {
  ...
  addNumericSlider = (
    ...
    const controllerName = displayName ? displayName : propertyName
    const gui = this._getGui(folderName).open(!!open)
   ...
   */
  addButton = (obj: object, propertyName: string, displayName?: string | undefined, folderName?: string | undefined) => {
    const controllerName = displayName ? displayName : propertyName
    const gui = this._getGui(folderName)
   ...
   */
  addCheckBox = (obj: object, propertyName: string, displayName?: string | undefined, folderName?: string | undefined) => {
    const controllerName = displayName ? displayName : propertyName
    const gui = this._getGui(folderName)
